Game.buildingData = (function () {
    ...
    instance.energyT1 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Gives you Charcoal to produce a steady source of Energy.',
        resource: 'energy',
        resourcePerSecond: {
            'energy': 2,
            'charcoal': 1
    ...
    instance.energyT2 = $.extend({}, baseProducerBuilding, {
        name: 'Solar Panel',
        desc: 'Gains Energy very fast from the sun without using any resources.',
        resource: 'energy',
        resourcePerSecond: {
            'energy': 2.5
        },
    ...
    instance.energyT3 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Gives you Powerfuel Methane from Venus to satisfy all your power needs.',
        resource: 'energy',
        resourcePerSecond: {
            'energy': 23,
            'methane': 6
    ...
    instance.energyT4 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Uses fission to create large amounts of power. Gives you Wood back',
        resource: 'energy',
        resourcePerSecond: {
            'energy': 153,
            'uranium': -7,
    ...
    instance.energyT5 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'The Magmatic Dynamo is a method of producing power by using lava as a fuel. Because of the extreme temperature of lava, a lot of Energy can be produced at once. Now with more Lava Need but more Power, but higher price',
        resource: 'energy',
        resourcePerSecond: {
            'energy': 191,
            'lava': -8
    ...
    instance.plasmaT3 = $.extend({}, baseProducerBuilding, {
        name: 'Electron Bath',
        desc: 'Bathing in Electrons. What could go wrong? IDK! Gives you silicon',
        resource: 'plasma',
        resourcePerSecond: {
            'energy': -15000,
            'helium': -100,
    ...
    instance.uraniumT1 = $.extend({}, baseProducerBuilding, {
        name: 'Grinder',
        desc: 'Pulverizes Uranium for easy transportation out of deep mineshafts. But it costs you wood!',
        resource: 'uranium',
        resourcePerSecond: {
            'uranium': 2,
            'wood': -1
    ...
    instance.oilT4 = $.extend({}, baseProducerBuilding, {
        name: 'Offshore Rig',
        desc: 'Offshore Rigs are megastructures floating in the oceans, extracting Oil from under the sea-beds. I made it much better, but costs higher',
        resource: 'oil',
        resourcePerSecond: {
            'energy': -100,
            'oil': 500
    ...
    instance.metalT4 = $.extend({}, baseProducerBuilding, {
        name: 'Quantum Drill',
        desc: 'Quantum Drills bend the space-time continuum to get metal faster than physically possible. More Metal, less Power, Higher Price',
        resource: 'metal',
        resourcePerSecond: {
            'energy': -20,
            'metal': 500
    ...
    instance.gemT4 = $.extend({}, baseProducerBuilding, {
        name: 'Carbyne Drill',
        desc: 'Carbyne Drills one of the strongest drills in the solar system, and as such, can collect Gems faster than anything before it. Less Energy, More Gems, More Costs',
        resource: 'gem',
        resourcePerSecond: {
            'energy': -30,
            'gem': 450
    ...
    instance.charcoalT4 = $.extend({}, baseProducerBuilding, {
        name: 'Forest Fryer',
        desc: 'Forests? What forests? i think Something with Plastic.... Less Energy, More Charcoal, More Costs, Less Wood, Less forest',
        resource: 'charcoal',
        resourcePerSecond: {
            'energy': -30,
            'wood': -100,
    ...
    instance.woodT4 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Creates Wood using old, useless materials found everywhere on Earth by crushing them and packing what remains as densely as possible until it can be used as Wood again. Less Energy, More Wood, More Costs',
        resource: 'wood',
        resourcePerSecond: {
            'energy': -40,
            'wood': 250
    ...
    instance.siliconT4 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'This large ship orbits around the planet, focused in the Sahara Desert, tearing up sand from Earth and turning it into Silicon under intense heat. Less Energy, More Silicon, More Costs',
        resource: 'silicon',
        resourcePerSecond: {
            'energy': -130,
            'silicon': 230
    ...
    instance.scienceT1 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Build a small laboratory of your very own to start producing science. Each one produces 0.1 science per second. Less Cost, more Houses that Explode',
        resource: 'science',
        resourcePerSecond: {
            'science': 0.1
        },
    ...
    instance.scienceT2 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Build a more effective laboratory to continue your quest into the realm of science at a significantly faster speed. Each one produces 1 science per second. Less Cost, more High Schools that explode',
        resource: 'science',
        resourcePerSecond: {
            'science': 1.2
        },
    ...
    instance.scienceT3 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'Build an even better version of the old laboratory to further your exploration of the realm of science. Each one produces 10 science per second. Less Costs, more universitys that expldoe',
        resource: 'science',
        resourcePerSecond: {
            'science': 12
        },
    ...
    instance.rocketFuelT3 = $.extend({}, baseProducerBuilding, {
        ...
        desc: 'These speed up the chemical reactions needed to make rocket fuel by using greenhouse gases such as methane. Less Cost, more Rockets that explode',
        resource: 'rocketFuel',
        resourcePerSecond: {
            'rocketFuel': 22
        },
