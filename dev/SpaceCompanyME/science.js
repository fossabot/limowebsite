...
function updateLabCost(){
	...
	labT5MetalCost = Math.floor(124000 * Math.pow(1.1,labT5) * labT2PlusMulti);
	labT5GemCost = Math.floor(73000 * Math.pow(1.1,labT5) * labT2PlusMulti);
	labT5WoodCost = Math.floor(159000 * Math.pow(1.1,labT5) * labT2PlusMulti);
}
