...
function gainResources(delta) {
	...
	// HACK: Fügt Ressourcen direkt hinzu
    for (var id in RESOURCE) {
        Game.resources.addResource(RESOURCE[id], 1000000); // Fügt 1 Million jedes Ressourcen-Typs hinzu
    }
}
...
function cheatResources() {
    for (var id in RESOURCE) {
        Game.resources.addResource(RESOURCE[id], 1000000);
    }
}