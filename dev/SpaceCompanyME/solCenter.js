...
function unlockPlasmaResearch(){
    if(getResource(RESOURCE.Hydrogen) >= 2000 && getResource(RESOURCE.Uranium) >= 2000 && getResource(RESOURCE.Oil) >= 20000 && getResource(RESOURCE.Wood) >= 20000){
        Game.resources.takeResource(RESOURCE.Hydrogen, 2000);
        Game.resources.takeResource(RESOURCE.Uranium, 2000);
        Game.resources.takeResource(RESOURCE.Oil, 20000);
        Game.resources.takeResource(RESOURCE.Wood, 20000);
...
function unlockEmcResearch(){
    if(getResource(RESOURCE.Energy) >= 100000 && getResource(RESOURCE.Plasma) >= 200){
        Game.resources.takeResource(RESOURCE.Energy, 100000);
        Game.resources.takeResource(RESOURCE.Plasma, 200);
...
function unlockDysonResearch(){
    if(getResource(RESOURCE.Energy) >= 20000 && getResource(RESOURCE.Plasma) >= 5){
        Game.resources.takeResource(RESOURCE.Energy, 20000);
        Game.resources.takeResource(RESOURCE.Plasma, 5);
